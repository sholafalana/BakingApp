...
public class RecipeDetailedAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void setRecipeData(ParseRecipe recipe) {
        this.recipe = recipe;
    ...
    private TitleViewHolder getTitleViewHolder(Context context, ViewGroup viewGroup) {
        int layoutIdForListItem = R.layout.recipe_detailed_title_item;
    ...
    private IngredientViewHolder getIngredientViewHolder(Context context, ViewGroup viewGroup) {
        int layoutIdForListItem = R.layout.recipe_detailed_ingredient_cardview_item;
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(layoutIdForListItem, viewGroup, false);
    ...
    private StepViewHolder getStepViewHolder(Context context, ViewGroup viewGroup) {
        int layoutIdForListItem = R.layout.recipe_detailed_step_cardview_item;
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(layoutIdForListItem, viewGroup, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        switch (holder.getItemViewType()) {
            ...
            case STEP_TYPE:
                ...
                int color = selectedIndex == index ? R.color.Lightbrown : R.color.veryLightbrown;
    ...
    class IngredientViewHolder extends RecyclerView.ViewHolder {
        ...
        void appendIngredients(LinearLayout parentLayout) {
            ...
            for (IngredientsItem ingredient : recipe.getIngredients()) {
                view = inflater.inflate(R.layout.recipe_detailed_ingredient_item, parentLayout, false);
